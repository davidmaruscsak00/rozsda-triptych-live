...
// it. The pivot is the foot of the centre panel, which stands at (x, z) facing
// the viewer; view/xr.js fixes it BACK_M ahead of the session's origin.
export const place = {
  x: 0, z: 0,
...
// about 0.85 m away
export const BACK_M = parseFloat(qp.get('back') || '2.0');     // metres ahead of the origin
